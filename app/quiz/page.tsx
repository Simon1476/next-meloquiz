...
export default function QuizPage() {
  return (
    <main className="flex justify-between flex-col text-white max-w-6xl mx-auto h-screen">
      <section className="flex flex-col gap-4 items-center gap-max-w-screen-xl mx-auto pt-24 font-bold my-5 text-white">
